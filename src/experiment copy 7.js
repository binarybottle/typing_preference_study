...
async function runExperiment() {
  ...
  console.log("OSF API Token:", osfToken);
 ...
 // Function to store data on OSF
  async function storeDataOnOSF(data) {
    ...
    // Step 1: Create the file on OSF
    const createFileUrl = `https://api.osf.io/v2/nodes/${osfNodeId}/files/`;
    ...
    try {
      ...
      // Step 2: Upload the data to the created file
